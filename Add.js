...
const styles = StyleSheet.create({
  ...
  button: {paddingVertical: 10,paddingHorizontal: 20,borderRadius: 5,marginHorizontal: 5,},
  selectedExpense: {backgroundColor: 'red',},
  selectedIncome: {backgroundColor: 'green',},
